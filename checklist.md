...
* [x] Use `File → Save a Copy As` to make `commonsense.html`
...
* [x] Open `commonsense.html` that was saved previously.
...
* [x] `make sr`
* [x] Go to [project page](https://www.pgdp.net/c/project.php?id=projectID67bb3ab1bdd9d), select SR time period, upload `commonsense-sr.zip`
...
* [x] Add **anonymized** files to git, e.g. `commonsense-smoothread01.txt`
...
* [x] Enter copyright clearance (get from DP [project page](https://www.pgdp.net/c/project.php?id=projectID67bb3ab1bdd9d))
