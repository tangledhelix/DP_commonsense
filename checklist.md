...
./make_project.py
```
* [x] Read the [project comments](https://www.pgdp.net/c/project.php?id=projectID67bb3ab1bdd9d#project-comments)
* [x] Subscribe to the [forum topic](https://www.pgdp.net/phpBB3/viewtopic.php?t=83342) and read all posts
* [x] Open `commonsense-utf8.txt` in Guiguts
...
* [ ] Click `Diacritics/Ligatures`. Scan list looking for mistakes, inconsistent usages.
...
* [ ] Use `File → Save a Copy As` to make `commonsense.html`
...
* [ ] Open `commonsense.html` that was saved previously.
...
* [ ] `make sr`
* [ ] Go to [project page](https://www.pgdp.net/c/project.php?id=projectID67bb3ab1bdd9d), select SR time period, upload `commonsense-sr.zip`
...
* [ ] Add **anonymized** files to git, e.g. `commonsense-smoothread01.txt`
...
* [ ] Enter copyright clearance (get from DP [project page](https://www.pgdp.net/c/project.php?id=projectID67bb3ab1bdd9d))
...
* [ ] Credits line
  * Paste in from DP [project page](https://www.pgdp.net/c/project.php?id=projectID67bb3ab1bdd9d)
